...
public class PlayerInput : MonoBehaviour
{
    ...
    // Don't add facingRight immediately; try to see if people think of the naive
   // way first
private bool facingRight = true;
    ...
    // Consider adding a bool for negative downward velocity in order to determine
   // isFalling
void OnCollisionExit2D(Collision2D other)
    ...
    // This gets added after the discussion of flipping a character -- it's not
   // even an animator thing!
void Flip()
    {
